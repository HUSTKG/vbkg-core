...
-- ============================================================================
-- 1. CORE EXEC_SQL FUNCTION
-- ============================================================================

-- Drop existing function if exists
DROP FUNCTION IF EXISTS exec_sql(text, json);
DROP FUNCTION IF EXISTS exec_sql_with_params(text, json);
...
BEGIN
  ...
  RAISE NOTICE 'Executing SQL: %', query_text;
  RAISE NOTICE 'With params: %', query_params;
  
  -- Determine query type
  query_type := UPPER(SPLIT_PART(TRIM(query_text), ' ', 1));
