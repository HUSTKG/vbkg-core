...
def validate_entity_type(
    entity_type: str, allowed_types: List[str] | None = None
) -> Dict[str, Any]:
    """
...
def validate_relationship_type(
    relationship_type: str, allowed_types: List[str] | None = None
) -> Dict[str, Any]:
    """
    ...
    if allowed_types and relationship_type not in allowed_types:
        errors.append(
            f"Invalid relationship type. Allowed types: {', '.join(allowed_types)}"
        )
